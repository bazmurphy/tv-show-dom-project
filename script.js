...
function createTitle() {
  ...
  // titleLink.href = "https://github.com/bazmurphy/tv-show-dom-project";
...
function createSearch() {
  ...
  selectInput.addEventListener("change", selectSpecificEpisode);

  const defaultBlankSelectOption = document.createElement("option");
  defaultBlankSelectOption.textContent = "Select a specific episode...";
  ...
  defaultBlankSelectOption.value = "none";
  selectInput.appendChild(defaultBlankSelectOption);
  ...
  searchResultsInfoSpanTwo.textContent = allEpisodes.length;
  ...
  searchResultsInfoSpanFour.textContent = allEpisodes.length;
  ...
  searchContainer.appendChild(selectInput);
  searchContainer.appendChild(searchInput);
  searchContainer.appendChild(searchResetButton);
  searchContainer.appendChild(searchResultsInfoContainer);
...
function renderMain(episodesArray) {
...
function createFooter() {
  ...
  footerSpanOne.textContent = "Data originally from";

  const footerSpanTwo = document.createElement("a");
  footerSpanTwo.classList.add("footer-span-two");
  footerSpanTwo.href = "https://www.tvmaze.com/";
  footerSpanTwo.target = "_blank";
  footerSpanTwo.textContent = "TVMaze.com";
